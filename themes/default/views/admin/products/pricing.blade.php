            ...
            <div class="mt-4">
                ...
                @elseif($pricing->type == 'recurring')
                    <div class="flex flex-row text-sm gap-4 mt-2">
                        <!-- Weekly Price and Setup -->
                        <div class="flex flex-col">
                            <label class="text-gray-700 dark:text-darkmodetext" for="weekly">
                                {{ __('Weekly') }}
                            </label>
                            <input type="text" name="weekly" id="weekly" value="{{ $pricing->weekly }}"
                                class="form-input">
                            <label class="text-gray-700 dark:text-darkmodetext" for="weekly_setup">
                                {{ __('Weekly Setup Fee') }}
                            </label>
                            <input type="text" name="weekly_setup" id="weekly_setup"
                                value="{{ $pricing->weekly_setup }}" class="form-input">
                        </div>
                        <!-- Monthly Price and Setup -->
                        <div class="flex flex-col">
