...
class ProductController extends Controller
{
    ...
    public function pricingUpdate(Request $request, Product $product)
    {
        $request->validate([
            ...
            'weekly' => 'nullable|numeric|min:0',          // Validación para el campo weekly
            'weekly_setup' => 'nullable|numeric|min:0',    // Validación para el campo weekly_setup
            'monthly' => 'nullable|numeric|min:0',
            'quarterly' => 'nullable|numeric|min:0',
            'semi_annually' => 'nullable|numeric|min:0',
            ...
            'semi_annually_setup' => 'nullable|numeric|min:0',
        ...
        $product->prices->update([
            'weekly' => $request->get('weekly'),              // Actualización para el campo weekly
            'weekly_setup' => $request->get('weekly_setup'),  // Actualización para el campo weekly_setup
